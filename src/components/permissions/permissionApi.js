...
export const fetchDepartmentMatrix = () => jget('/permissions/department-matrix')
export const saveDepartmentPerm    = (department_id, perm_keys) => jput('/permissions/department-matrix', { department_id, perm_keys })
