...
export default function CustomsMobile({ rows, onEdit, onDelete, fmtVND, fmtDate, customsStatusStyle, totalCost }) {
  if (rows.length === 0) {
  ...
  return (
    <div className="mcards" style={{ padding: 12 }}>
      {rows.map((row, i) => {
        ...
        return (
          <div key={row.id} className="mcard" onClick={() => onEdit(row)}>
            ...
            <div className="mcard-meta">
              ...
              {cost > 0 && <span>CP: {fmtVND(cost)}đ</span>}
            </div>
